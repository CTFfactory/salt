...
/*
 * PHASE 3: Advanced UTF-8 edge cases
 * Verify RFC 8259 JSON string validation for all UTF-8 scenarios.
 */

void test_salt_cli_json_output_overlong_utf8_nul_rejected(void **state) {
    /* Overlong UTF-8 encoding of U+0000 (invalid per RFC 3629) */
    char key_id_bytes[] = {(char)0xC0, (char)0x80, '\0'};
    char *argv[] = {(char *)"salt",       (char *)"--output", (char *)"json", (char *)"--key",
                    (char *)"base64-key", (char *)"--key-id", key_id_bytes,   (char *)"hello"};
    FILE *in_stream = stream_from_text(NULL);
    FILE *out_stream = test_tmpfile_checked();
...
void test_salt_cli_json_output_invalid_surrogate_pair_rejected(void **state) {
    /* Invalid UTF-8 surrogate pair (ED A0 80 = U+D800) */
    char key_id_bytes[] = {(char)0xED, (char)0xA0, (char)0x80, '\0'};
    char *argv[] = {(char *)"salt",       (char *)"--output", (char *)"json", (char *)"--key",
                    (char *)"base64-key", (char *)"--key-id", key_id_bytes,   (char *)"hello"};
    FILE *in_stream = stream_from_text(NULL);
    FILE *out_stream = test_tmpfile_checked();
...
void test_salt_cli_json_output_incomplete_utf8_sequence_rejected(void **state) {
    /* Incomplete UTF-8 sequence (C3 without continuation byte) */
    char key_id_bytes[] = {(char)0xC3, '\0'};
    char *argv[] = {(char *)"salt",       (char *)"--output", (char *)"json", (char *)"--key",
                    (char *)"base64-key", (char *)"--key-id", key_id_bytes,   (char *)"hello"};
    FILE *in_stream = stream_from_text(NULL);
    FILE *out_stream = test_tmpfile_checked();
...
void test_salt_cli_json_output_valid_multibyte_utf8_success(void **state) {
    /* Valid UTF-8: E2 98 83 = U+2603 (☃ snowman) */
    char key_id_bytes[] = {(char)0xE2, (char)0x98, (char)0x83, '\0'};
    char *argv[] = {(char *)"salt",       (char *)"--output", (char *)"json", (char *)"--key",
                    (char *)"base64-key", (char *)"--key-id", key_id_bytes,   (char *)"hello"};
    FILE *in_stream = stream_from_text(NULL);
    FILE *out_stream = test_tmpfile_checked();
    ...
    read_stream(out_stream, stdout_buffer, sizeof(stdout_buffer));
    read_stream(err_stream, stderr_buffer, sizeof(stderr_buffer));
    /* Should contain the valid UTF-8 bytes in output */
    assert_non_null(stdout_buffer);
    assert_string_equal(stderr_buffer, "");
...
int run_cli_json_tests(void) {
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test_setup_teardown(test_salt_cli_json_output_locale_independent,
                                        cli_test_setup, cli_test_teardown),
        /* PHASE 3: Advanced UTF-8 edge cases */
        cmocka_unit_test_setup_teardown(test_salt_cli_json_output_overlong_utf8_nul_rejected,
                                        cli_test_setup, cli_test_teardown),
        cmocka_unit_test_setup_teardown(test_salt_cli_json_output_invalid_surrogate_pair_rejected,
                                        cli_test_setup, cli_test_teardown),
        cmocka_unit_test_setup_teardown(test_salt_cli_json_output_incomplete_utf8_sequence_rejected,
                                        cli_test_setup, cli_test_teardown),
        cmocka_unit_test_setup_teardown(test_salt_cli_json_output_valid_multibyte_utf8_success,
                                        cli_test_setup, cli_test_teardown),
    };
