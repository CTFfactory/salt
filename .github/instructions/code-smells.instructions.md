...
- **Inappropriate intimacy / leaky internals** — public headers in `include/` must not expose helpers meant for `src/` only. Internal helpers belong in `src/cli/internal.h`.
